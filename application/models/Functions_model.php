...
class Functions_model extends CI_Model {
    ...
    public function SendEmail($to, $nameTo, $subject, $message) {
            $this->load->library("Mymailer");

            $mail = $this->mymailer->Load();
            ...
            $mail->Port = 587;
            $mail->SMTPSecure = 'tls';
            $mail->Username = "no-reply@emmigre.com";
            $mail->Password = 'P3nsament@';
            //$mail->From = 'AKIASYK3JYW4UXA3RBPG';
            $mail->setFrom('no-reply@emmigre.com', 'Emmigre');
                ...
                <table align="center" cellpadding="0" cellspacing="0" class="container-for-gmail-android" width="100%">
                    <tr>
                        <td align="left" valign="top" width="100%"
                            ...
                            <center>
                                <img src="https://emmigre.com/images/emmigre-logo.png"
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                                    <tr>
                                                        <td style="vertical-align: middle;">
                                                            <a href=""><img width="137" height="50"
                                                                    src="https://emmigre.com/images/emmigre-logo.png"
                                                                    alt="logo"></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                ...
                                <table cellspacing="0" cellpadding="0" width="600" class="w320">
                                    <tr>
                                        <td style="padding: 25px 0 25px">
                                            <a href="https://emmigre.com ">www.emmigre.com </a>       
                                        </td>
                                    </tr>
                                </table>
                            </center>
                        ...
                        <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" >
                            <center>
                                <table cellspacing="0" cellpadding="0" width="600" class="w320">
                                    <tr>
                                        <td style="padding: 25px 0 25px">
                                            <strong>Um produto do grupo Findus Brasil</strong><br />
            ...
            $this->db->insert('tbl_Logs', array('ds_Log' => $mail->ErrorInfo,
