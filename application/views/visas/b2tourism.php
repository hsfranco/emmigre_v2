							...
							<div class="col">
								<nav aria-label="breadcrumb">
								  	<ol class="breadcrumb white-color">
								    	...
								    	<li class="breadcrumb-item"><a href="couching-list.html">Todos Vistos</a></li>
								    	<li class="breadcrumb-item active" aria-current="page">B1/B2 Turismo</li>
								  	</ol>
								</nav>
							</div>
						</div>  <!-- End row -->
									...
									<div class="a-9-boxes row bg-lightgrey d-flex align-items-center">
										...
										<div class="col-md-4">
											<div class="a9-box icon-xs">
												...
												<!-- Text -->
												<div class="a9-txt"> 
													<p class="grey-color txt-400">Duração</p>
													<p class="blue-color">Em média 24 horas</p>
												</div>
										...
										<div class="col-md-4">
											<div class="a9-box icon-xs">
												...
												<!-- Text -->
												<div class="a9-txt"> 
													<p class="grey-color txt-400">Dificuldade</p>
													<p class="blue-color">Simples</p>
												</div>
